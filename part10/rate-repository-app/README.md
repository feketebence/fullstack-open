...
You will need a locally running Android device emulator.
...
Run `npm start` to start the Expo server and press `a` to load the app onto the emulated Android device
